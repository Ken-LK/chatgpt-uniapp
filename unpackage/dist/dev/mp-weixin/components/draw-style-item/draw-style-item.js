  ...
  return {
    a: common_vendor.f($props.options, (item, index, i0) => {
      return {
        ...
        b: item.imgUrl,
        c: common_vendor.n(item.active ? "grid-item-box item-active" : "grid-item-box"),
        d: common_vendor.o(($event) => $options.click($props.options, item), index),
        e: index,
        f: "90f9ab58-2-" + i0 + ",90f9ab58-1",
        g: common_vendor.p({
          index
        })
      };
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/ken/Documents/HBuilderProjects/chatgpt-uniapp/components/draw-style-item/draw-style-item.vue"]]);
