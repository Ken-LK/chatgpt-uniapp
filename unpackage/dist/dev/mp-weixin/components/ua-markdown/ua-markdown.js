  ...
  setup(__props) {
    ...
    const parseNodes = (value) => {
      ...
      if (vvArr.length > 1) {
        ...
        htmlString = markdown.renderInline(value);
      }
    ...
    return (_ctx, _cache) => {
      return {
        ...
        c: common_vendor.s("width:" + __props.width)
      };
    };
  }
};
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-64f4d077"], ["__file", "/Users/ken/Documents/HBuilderProjects/chatgpt-uniapp/components/ua-markdown/ua-markdown.vue"]]);
